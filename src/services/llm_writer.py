...
class OllamaProvider(LLMProvider):
    """
    Local LLM Provider using Ollama (Native API).
    """
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.client = Client()
        logger.info(f"Initialized Ollama Provider (Model: {self.model_name})")
    ...
    def generate_summary(self, title: str, text: str) -> str:
        ...
        try:
            ...
            # Native client returns a dict accessing message content directly
